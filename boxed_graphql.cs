...
#:package HotChocolate.Data.EntityFramework@13.0.0
...
// 2. 高性能通道(RingBuffer + Disruptor模式)
...
// 4. Boxed模板集成
builder.Services.AddBoxedGraphQL(options =>
{
...
app.MapGraphQL();
app.MapGet("/", () => "Boxed GraphQL API Ready");
app.Run();
