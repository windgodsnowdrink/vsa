...
// 使用Mapperly生成映射器
[global::Mapperly.Abstractions.Mapper]
public static partial class TodoMapper
{
    [global::Mapperly.Abstractions.MapProperty("Id", "TodoId")]
    [global::Mapperly.Abstractions.MapProperty("Title", "TodoTitle")]
    [global::Mapperly.Abstractions.MapProperty("IsCompleted", "IsDone")]
    public static partial TodoItemDto MapToDto(TodoItem item);
}
...
app.MapGet("/todos/{id}", (int id) =>
{
    ...
    // 使用Mapperly生成的映射器进行对象映射
    var todoDto = TodoMapper.MapToDto(todoItem);
