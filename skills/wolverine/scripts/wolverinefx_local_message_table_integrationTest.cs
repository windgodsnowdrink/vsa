...
Console.WriteLine("=== wolverinefx_local_message_table_integration Test ===");
...
try
{
    ...
    var t2 = typeof(OutboxMiddleware);
    Console.WriteLine($"[PASS] OutboxMiddleware 存在");
    var t3 = typeof(OutboxProcessor);
    Console.WriteLine($"[PASS] OutboxProcessor 存在");
    var t4 = typeof(WolverineDependencyInjectionExtensions);
