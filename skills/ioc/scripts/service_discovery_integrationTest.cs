...
Console.WriteLine("=== service_discovery_integration Test ===");

try
{
    var t0 = typeof(ServiceDiscoveryHealthCheck);
    Console.WriteLine($"[PASS] ServiceDiscoveryHealthCheck 存在");
    var t1 = typeof(SmartLoadBalancerFactory);
    Console.WriteLine($"[PASS] SmartLoadBalancerFactory 存在");
    var t2 = typeof(SmartLoadBalancer);
    ...
    var t5 = typeof(ServiceDiscoveryOptions);
    Console.WriteLine($"[PASS] ServiceDiscoveryOptions 存在");
