...
public class Program
{
    public static async Task Main()
    {
        ...
        Console.WriteLine("litedb Basic Usage Example");
        Console.WriteLine("=" * 50);
        
        // Use litedb functionality
...
public class Program
{
    public static async Task Main()
    {
        Console.WriteLine("litedb Advanced Configuration Example");
        Console.WriteLine("=" * 50);
...
public class Program
{
    public static async Task Main()
    {
        Console.WriteLine("litedb Performance Optimization Example");
        Console.WriteLine("=" * 50);
...
public class Program
{
    public static async Task Main()
    {
        Console.WriteLine("litedb Error Handling Example");
        Console.WriteLine("=" * 50);
...
The above examples demonstrate the main functions and usage methods of the litedb skill. Through these examples, you can:
