...
public class Program
{
    public static async Task Main()
    {
        ...
        Console.WriteLine("otel Basic Usage Example");
        Console.WriteLine("=" * 50);
        
        // Use otel functionality
...
public class Program
{
    public static async Task Main()
    {
        Console.WriteLine("otel Advanced Configuration Example");
        Console.WriteLine("=" * 50);
...
public class Program
{
    public static async Task Main()
    {
        Console.WriteLine("otel Performance Optimization Example");
        Console.WriteLine("=" * 50);
...
public class Program
{
    public static async Task Main()
    {
        Console.WriteLine("otel Error Handling Example");
        Console.WriteLine("=" * 50);
...
The above examples demonstrate the main functions and usage methods of the otel skill. Through these examples, you can:
