...
public class Program
{
    public static async Task Main()
    {
        ...
        Console.WriteLine("fastreport Basic Usage Example");
        Console.WriteLine("=" * 50);
        
        // Use fastreport functionality
...
public class Program
{
    public static async Task Main()
    {
        Console.WriteLine("fastreport Advanced Configuration Example");
        Console.WriteLine("=" * 50);
        
        // Build service container
        var builder = new ServiceCollection();
        
        // Configure fastreport settings
...
public class Program
{
    public static async Task Main()
    {
        Console.WriteLine("fastreport Performance Optimization Example");
        Console.WriteLine("=" * 50);
...
public class Program
{
    public static async Task Main()
    {
        Console.WriteLine("fastreport Error Handling Example");
        Console.WriteLine("=" * 50);
...
The above examples demonstrate the main functions and usage methods of the fastreport skill. Through these examples, you can:
