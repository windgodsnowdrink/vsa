...
try
{
    ...
    var t2 = typeof(AvaloniaIntegration.App);
    Console.WriteLine($"[PASS] App 存在");
    var t3 = typeof(AvaloniaIntegration.MainViewModel);
    Console.WriteLine($"[PASS] MainViewModel 存在");
    var t4 = typeof(AvaloniaIntegration.MainWindow);
    Console.WriteLine($"[PASS] MainWindow 存在");
    var t5 = typeof(AvaloniaIntegration.AvaloniaExtensions);
    Console.WriteLine($"[PASS] AvaloniaExtensions 存在");
