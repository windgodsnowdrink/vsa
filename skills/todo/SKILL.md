# todo Agent Skill - todo Skill

## Skill Overview

High performance todo skill based on .NET 10, providing powerful todo functionality for .NET developers.
...
Register todo services in your main application:
...
1. **Core Feature 1**: todo core feature description
2. **Core Feature 2**: todo core feature description
3. **Core Feature 3**: todo core feature description
...
This skill provides a complete todo solution that you can extend as needed:

1. **Custom Implementation**: Implement the I interface
2. **Extend Features**: Add new todo features
