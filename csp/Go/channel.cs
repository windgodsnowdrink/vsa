...
struct priority_queue<T>
{
    ...
    /// 添加通知节点到队列
    /// </summary>
    /// <param name="priority">通知优先级</param>
    /// <param name="queue">通知队列</param>
    /// <param name="value">通知值</param>
    /// <returns>通知节点</returns>
...
internal abstract class select_chan_base
{
    ...
    /// 调用选择通道
    /// </summary>
    /// <param name="stepOne">单步任务</param>
    /// <returns>选择通道状态</returns>
...
public abstract class chan_base
{
    ...
    protected static bool _mustTick;
    ...
    /// <param name="token">广播令牌</param>
    /// <param name="ntfSign">通知签名</param>
    public void async_remove_recv_notify(Action<chan_state> ntf, broadcast_token token, chan_notify_sign ntfSign)
    {
        if (self_strand().running_in_this_thread())
            if (!_mustTick) async_remove_recv_notify_(ntf, ntfSign);
            else self_strand().add_last(() => async_remove_recv_notify_(ntf, ntfSign));
    ...
    /// 安全回调
    /// </summary>
    /// <param name="queue1">通知队列1</param>
    /// <param name="queue2">通知队列2</param>
    /// <param name="state">状态</param>
...
public abstract class chan<T> : chan_base
{
    ...
    internal class select_chan_reader : select_chan_base
    {
        ...
        /// 调用
        /// </summary>
        /// <param name="stepOne">单步调用</param>
        /// <returns>选择器通道状态</returns>
    ...
    /// 异步发送
    /// </summary>
    /// <param name="ntf">通知</param>
    /// <param name="msg">消息</param>
    /// <param name="ntfSign">通知信号</param>
    ...
    /// </summary>
    /// <param name="handler">处理函数</param>
    /// <param name="errHandler">错误处理函数</param>
    /// <param name="lostMsg">丢失消息</param>
    /// <returns>选择器读取器</returns>
    ...
    /// <param name="msgNtf">消息通知函数</param>
    /// <param name="token">广播令牌</param>
    /// <param name="ntfSign">通知签名</param>
    /// <param name="ms">毫秒</param>
...
public class unlimit_chan<T> : chan<T>
{
    ...
    /// 异步发送
    /// </summary>
    /// <param name="ntf">处理函数</param>
    /// <param name="msg">消息</param>
    /// <param name="ntfSign">通知令牌</param>
    ...
    /// </summary>
    /// <param name="ntf">处理函数</param>
    /// <param name="isClear">是否清除队列</param>
...
public class limit_chan<T> : chan<T>
{
    ...
    /// 强制发送消息
    /// </summary>
    /// <param name="cb">回调令牌</param>
    /// <param name="msgNtf">消息令牌</param>
    /// <param name="ntfSign">通知令牌</param>
    /// <param name="ms">超时时间</param>
    /// <returns>任务</returns>
    protected override void async_try_recv_and_append_notify_(Action<chan_recv_wrap<T>> cb, Action<chan_state> msgNtf, chan_notify_sign ntfSign, int ms)
    ...
    /// </summary>
    /// <param name="ntf">通知令牌</param>
    /// <param name="isClear">是否清除消息队列</param>
    /// <returns>任务</returns>
    protected override void async_close_(Action ntf, bool isClear = false)
    {
        _closed = true;
...
public class csp_chan<R, T> : chan_base
{
    ...
    /// 选择写入通道
    /// </summary>
    /// <typeparam name="R">读取类型</typeparam>
    /// <typeparam name="T">写入类型</typeparam>
    ...
    /// 通道
    /// </summary>
    /// <param name="invokeMs">超时时间</param>
    /// <param name="ntf">通知函数</param>
    /// <param name="msg">消息</param>
    /// <param name="ntfSign">通知签名</param>
    ...
    /// 通道
    /// </summary>
    /// <param name="invokeMs">调用时间</param>
    /// <param name="ntf">通知函数</param>
    /// <param name="msg">消息</param>
    /// <param name="ntfSign">通知信号</param>
