...
[assembly: RootNamespace("Localization")]
...
try
{
    ...
    const string resourceDirectory = "Localization";
    builder.Configuration.AddJsonFile("appsettings.json", optional: true, reloadOnChange: true)
        .AddJsonFile($"appsettings.{builder.Environment.EnvironmentName}.json", optional: true, reloadOnChange: true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{resourceDirectory}{Path.DirectorySeparatorChar}zh-CN.json", optional: false, reloadOnChange: true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{resourceDirectory}{Path.DirectorySeparatorChar}zh-TW.json", optional: false, reloadOnChange: true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{resourceDirectory}{Path.DirectorySeparatorChar}en-US.json", optional: false, reloadOnChange: true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}cache.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}cors.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}eventbus.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}localization.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}logger.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}logger.staging.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}mail.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}middleware.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}minio.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}nacos.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}quartz.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}openapi.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}security.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}securityheaders.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}serilog.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}signalr.json", false, true)
        .AddJsonFile($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}{configurationsDirectory}{Path.DirectorySeparatorChar}zipkin.json", false, true)
    ...
    builder.Host.ConfigureContainer<ContainerBuilder>(cb =>
    {
        ...
        cb.RegisterBuildCallback(c =>
            Console.WriteLine(c.ComponentRegistry
                            .Registrations
...
{
    Console.WriteLine($"Null 实例注册错误: {ex.Message}");
    Console.WriteLine($"参数名: {ex.ParamName}");
}
catch (Exception ex) when (!ex.GetType().Name.Equals("StopTheHostException", StringComparison.OrdinalIgnoreCase))
{
#if DEBUG
    Console.Error.WriteLine(ex);
#endif
    Log.Fatal(ex, $"未处理的异常{ex.GetType().FullName}:{ex.StackTrace}");
}
finally
{
    Log.Information("服务器正在关闭中...");
    Log.CloseAndFlush();
}
