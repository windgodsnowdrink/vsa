...
Console.WriteLine("=== keycloak_integration Test ===");
...
try
{
    ...
    var t2 = typeof(KeycloakExtensions);
    Console.WriteLine($"[PASS] KeycloakExtensions 存在");
    var t3 = typeof(AuthRequest);
    Console.WriteLine($"[PASS] AuthRequest record 存在");
    var t4 = typeof(AuthResult);
