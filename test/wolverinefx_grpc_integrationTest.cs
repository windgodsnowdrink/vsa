...
Console.WriteLine("=== wolverinefx_grpc_integration Test ===");
...
try
{
    ...
    var t2 = typeof(WolverineGatewayService);
    Console.WriteLine($"[PASS] WolverineGatewayService 存在");
    ...
    var t6 = typeof(IWolverineGateway);
    Console.WriteLine($"[PASS] IWolverineGateway 接口存在 (IsInterface: {t6.IsInterface})");
